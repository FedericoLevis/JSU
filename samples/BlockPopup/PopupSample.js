...
function sample3JS(event){
  TipJSFixedClicked(JS3_OPT,event,{iMaxHeight:300,szTitle:"JS Source Code - Popup Option" });
}
...
function sample4JS(event){
  ...
  TipJSFixedClicked(szTip,event,{szTitle:"JS Source Code - Advanced Sample: =" + szType});
