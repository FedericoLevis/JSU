...
'		  <td class="tipNotPresent">Required <b>FULL JSU</b></td>' +
'	  </tr>' +
'	  <tr>' +
...
function showSampleLoading(){
  showSampleWindow(JSU_URL_SAMPLE_LOADING);
}
 ...
 * DAFARE
 */
function showSampleWindow(szUrl){
  window.open(szUrl,"_blank","menubar=1,resizable=1,menubar=1,width=100,height=100");
}
